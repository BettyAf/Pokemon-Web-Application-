...
import org.soen387.dom.command.WithdrawChallengeCommand;

public class WithdrawChallenge extends Dispatcher {

	public WithdrawChallenge(HttpServletRequest request, HttpServletResponse response) {
	...
	public void execute() throws ServletException, IOException {
		try {
			...
			myHelper.setRequestAttribute("message", "Command Success: Player withdraw from their challenge!");
